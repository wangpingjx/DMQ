<?php
namespace DMQ\Lib\Events;
require_once DMQ_ROOT_DIR . 'lib/events/interfaces.php';
...
class Libevent implements BaseEvent {
    ...
    public function del($fd ,$flag) {
        ...
        {
            // 读事件
            case \DMQ\Lib\Events\BaseEvent::EV_READ:
            case \DMQ\Lib\Events\BaseEvent::EV_WRITE:
            ...
            case \DMQ\Lib\Events\BaseEvent::EV_SIGNAL:
